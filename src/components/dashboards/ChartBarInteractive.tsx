...
export function ChartBarInteractive({
  ...
  return (
    <Card className={`py-0 overflow-hidden border transition-colors shadow-sm h-full flex flex-col ${
      ...
      <CardHeader className={`flex flex-col items-stretch border-b p-0 h-20 space-y-0 sm:flex-row ${
        darkMode ? 'border-gray-800' : 'border-gray-200'
      }`}>
        <div className="flex flex-1 flex-col justify-center gap-1 px-6 py-3.5">
          <CardTitle className={`text-lg font-bold ${darkMode ? 'text-white' : 'text-gray-900'}`}>
        ...
        <div className={`flex self-stretch border-t sm:border-t-0 sm:border-l ${
          darkMode ? 'border-gray-800' : 'border-gray-200'
        }`}>
          {/* Box 1: All Contributions */}
          <button
            data-active={activeChart === "total"}
            className={`relative z-30 flex flex-1 flex-col justify-center gap-1 border-r px-4 text-left transition-all ${
              darkMode
          ...
          >
            <span className={`text-xs font-medium flex items-center gap-1.5 whitespace-nowrap ${darkMode ? 'text-gray-400' : 'text-gray-500'}`}>
              <span className="w-2 h-2 rounded-full bg-violet-500 inline-block" />
              All Contributions
            </span>
            <span className="text-xl leading-none font-bold sm:text-2xl tracking-tight text-violet-400">
          ...
          >
            ...
            <span className="text-xl leading-none font-bold sm:text-2xl tracking-tight text-emerald-400">
          ...
          >
            ...
            <span className="text-xl leading-none font-bold sm:text-2xl tracking-tight text-blue-400">
          ...
          <button
            ...
            className={`relative z-30 flex flex-1 flex-col justify-center gap-1 px-4 text-left transition-all ${
              darkMode
          ...
          >
            ...
            <span className="text-xl leading-none font-bold sm:text-xl tracking-tight text-rose-400">

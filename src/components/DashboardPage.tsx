...
import { Plus, ChevronRight, Pencil, Home } from 'lucide-react';
        ...
        <div className="p-6 flex flex-col flex-1 overflow-y-auto">
          ...
          <div className="border-t border-gray-200 pt-4">
            <button
              ...
              className="w-full flex items-center gap-3 px-3 py-2 rounded-lg text-gray-700 hover:bg-red-50 hover:text-red-600 transition-all duration-200"
            >
        ...
        {showLogoutConfirm && (
          ...
          >
            ...
            >
              ...
              <p className="text-gray-600 mb-6">Are you sure you want to logout from your workspace?</p>
              <div className="flex justify-end gap-2">
                <button
                  onClick={() => setShowLogoutConfirm(false)}
                  className="px-4 py-2 border rounded hover:bg-gray-50"
...
const Header = () => (
  ...
  >
    <div className="flex items-center justify-between">
      <div>
        <h1 className="text-3xl font-bold text-gray-900 mb-1">Morning Team!</h1>
...
const DatabaseTable = ({ database, setDatabases }: { database: Database; setDatabases: any }) => {
  ...
  const handleDatabaseNameChange = () => {
    if (editedName.trim() && editedName !== database.name) {
      setDatabases((prev: Database[]) =>
        prev.map((db) => (db.id === database.id ? { ...db, name: editedName.trim() } : db))
      );
    } else {
          ...
          <div className="flex items-center gap-2">
            {isEditingName ? (
              <input
                ...
                autoFocus
                className="text-xl font-semibold text-gray-900 border-b-2 border-blue-500 focus:outline-none px-1"
              />
            ) : (
              <>
                <h2 

...
const DatabaseTable = ({ database }: { database: Database }) => {
  return (
    <motion.div
    ...
    >
      <div className="bg-white rounded-xl shadow-sm overflow-hidden">
        ...
        <div className="px-6 py-3 border-t border-gray-200 bg-gray-50">
          <button className="text-sm text-gray-500 hover:text-[#2563eb] transition-colors flex items-center gap-2">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <div className="flex-1 overflow-y-auto">
          <AnimatePresence mode="wait">
            {currentDatabase ? (
              <DatabaseTable key={currentDatabase.id} database={currentDatabase} />
            ) : (
